...
export default function Ingredients() {
  ...
  return (
    <div className="max-w-[1100px] mx-auto">
      ...
      {editing && <IngredientFormModal ingredient={editing} supplierNames={supplierNames} onSave={saveIngredient} onCancel={() => setEditing(null)} onDelete={editing.ingredientId ? () => setDeleteConfirm(editing.ingredientId!) : undefined} />}
